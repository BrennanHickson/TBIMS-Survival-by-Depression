...
# # (Google Material) Gray-to-Dark Blue
# "#ECEFF1", "#CFD8DC", "#B0BEC5", "#90A4AE", "#78909C", "#607D8B", "#546E7A", "#455A64", "#37474F", "#263238"

# Dual-Tone: "#CFD8DC", "#37474F"
# Tri-Tone: "#CFD8DC", "#546E7A", "#37474F"
# Quad-Tone: "#CFD8DC", "#90A4AE", "#546E7A", "#37474F"
# Text: "#0C1011"
```

## Prepare a Summarized Dataset with Unique Counts of Each Combination of Imputed Baseline/Year 1 Variable with `depression_level_at_year_1`

The imputation of `problematic_substance_use_at_injury` across all observations per unique participant needs to be accounted for so that the counts plot displays only one observation per participant and does not overestimate the total number of unique participants contributing to the dataset. The following summarized dataset will contain unique counts for each combination of `problematic_substance_use_at_injury` and `depression_level_at_year_1`.
  ...
  summarize(
    across(
      c(depression_level_at_year_1, employment_at_injury, marital_status_at_injury,
        ...
        mental_health_tx_hx, psych_hosp_hx,
        problematic_substance_use_at_injury, problematic_substance_use_at_year_1,
...
gg.mortality_pct <- ggplot(mortality_plot_pct_data,
  ...
  geom_text(aes(label = sprintf("%.1f%%", pct), y = pct / 2),  # Center text in the middle of each bar and format with one decimal place
            ...
            fontface = "bold",
            size = 2,
            color = c("#0C1011", "#FFFFFF", "#0C1011", "#FFFFFF", "#0C1011", "#FFFFFF", "#0C1011", "#FFFFFF",
                      "#0C1011", "#FFFFFF", "#0C1011", "#FFFFFF", "#0C1011", "#FFFFFF", "#0C1011", "#FFFFFF",
                      "#0C1011", "#FFFFFF", "#0C1011", "#FFFFFF", "#0C1011", "#FFFFFF", "#0C1011", "#FFFFFF",
                      "#0C1011", "#FFFFFF", "#0C1011", "#FFFFFF", "#0C1011", "#FFFFFF", "#0C1011", "#FFFFFF",
                      "#0C1011", "#FFFFFF", "#0C1011", "#FFFFFF", "#0C1011", "#FFFFFF", "#0C1011", "#FFFFFF",
                      "#0C1011", "#FFFFFF", "#0C1011", "#FFFFFF", "#0C1011", "#FFFFFF", "#FFFFFF",
                      "#0C1011", "#FFFFFF", "#0C1011", "#FFFFFF", "#0C1011", "#FFFFFF", "#0C1011", "#FFFFFF",
                      "#0C1011", "#FFFFFF", "#0C1011", "#FFFFFF", "#0C1011", "#FFFFFF", "#0C1011", "#FFFFFF",
                      "#FFFFFF")) +
  scale_y_continuous(labels = function(x) paste0(x, "%"),
...
### Figures 13-1 and 13-2: Counts and Percentages of History of Psychiatric Hospitalization by Year 1 Depression Level

```{r Plot Figure 13-1 (Final Analytic Sample)}
# Relevel the factor variable
analytic_data_final <- analytic_data_final |>
  mutate(psych_hosp_hx = factor(psych_hosp_hx, 
...
# Filter out NA values in 'mental_health_tx_hx' to display counts
psych_hosp_hx_by_depression_data <- analytic_data_final |> 
  drop_na(psych_hosp_hx)

# Calculate the counts for each depression level group
count_data_psych_hosp_hx <- psych_hosp_hx_by_depression_data |>
  count(depression_level_at_year_1, psych_hosp_hx)

# Create the counts plot
gg.psych_hosp_hx_by_depression <- ggplot(psych_hosp_hx_by_depression_data,
                                         aes(x = depression_level_at_year_1,
                                             fill = psych_hosp_hx)) +
  geom_bar(position = position_dodge(), stat = "count", color = "#263238", linewidth = 0.75) +
  scale_fill_manual(values = c("Denied any history of psychiatric hospitalization" = "#CFD8DC", 
                               "Psychiatric hospital admission prior to year preceding index injury only" = "#546E7A",
                               "Psychiatric hospital admission within year preceding index injury" = "#37474F")) +
  geom_text(data = count_data_psych_hosp_hx,
            aes(y = n/2, label = scales::comma(n)),  # Center text in the middle of each bar and format text with commas
            ...
            color = c("#0C1011", "#0C1011", "#0C1011",
                      ...
                      "#0C1011", "#0C1011", "#0C1011",
                      "#0C1011", "#0C1011", "#0C1011")) +
  labs(x = "Depression Level at Year 1", y = "Count", fill = "History of Psychiatric Hospitalization") +
  scale_y_continuous(labels = scales::comma, breaks = seq(0, 1500, by = 200)) +
  theme_classic() +
  customization +
  theme(
...
# Save the plot
ggsave(here(univariate_and_bivariate_plots_dir, "figure_13-1_psych_hosp_hx_by_depression_final_analytic_sample.png"),
       gg.psych_hosp_hx_by_depression, bg = "#FFFFFF", dpi = 300)
```
...
# Filter out NA values in 'mental_health_tx_hx' to display counts
psych_hosp_hx_by_depression_data <- complete_cases_all |> 
  drop_na(psych_hosp_hx)
...
# Save the plot
ggsave(here(univariate_and_bivariate_plots_dir, "figure_13-1_psych_hosp_hx_by_depression_complete_case_sample.png"),
       gg.psych_hosp_hx_by_depression, bg = "#FFFFFF", dpi = 300)
```
...
# Create the percentages plot
# Filter out NA values in 'mental_health_tx_hx' and calculate percentages
psych_hosp_hx_by_depression_pct_data <- analytic_data_final |> 
  drop_na(psych_hosp_hx, depression_level_at_year_1) |>
  count(depression_level_at_year_1, psych_hosp_hx) |> 
  group_by(depression_level_at_year_1) |>
  mutate(pct = n / sum(n) * 100)

# Create the mechanism of injury by depression level percentages plot
gg.psych_hosp_hx_by_depression_pct <- ggplot(psych_hosp_hx_by_depression_pct_data,
                                             aes(x = depression_level_at_year_1,
                                                 y = pct,
                                                 fill = psych_hosp_hx)) +
  geom_bar(position = position_dodge(), stat = "identity", color = "#263238", linewidth = 0.75) +
  scale_fill_manual(values = c("Denied any history of psychiatric hospitalization" = "#CFD8DC", 
                               ...
                               "Psychiatric hospital admission within year preceding index injury" = "#37474F")) +
  geom_text(aes(label = sprintf("%.1f%%", pct), y = pct / 2),  # Center text in the middle of each bar and format with one decimal place
            position = position_dodge(width = 0.9), vjust = -2.0,
            family = "Proxima Nova",
            fontface = "bold",
            size = 2.75,
            color = c("#0C1011", "#0C1011", "#0C1011",
                      "#0C1011", "#0C1011", "#0C1011",
                      "#0C1011", "#0C1011", "#0C1011")) +
  labs(x = "Depression Level at Year 1", y = "Percentage", fill = "History of Psychiatric Hospitalization") +
  scale_y_continuous(labels = function(x) paste0(x, "%"),
                     breaks = seq(0, 100, by = 20)) +  # Set breaks at every 10%
  theme_classic() +
  customization +
...
# Save the plot
ggsave(here(univariate_and_bivariate_plots_dir, "figure_13-2_psych_hosp_hx_by_depression_pct_final_analytic_sample.png"), 
       gg.psych_hosp_hx_by_depression_pct, bg = "#FFFFFF", dpi = 300)
```
...
# Create the percentages plot
# Filter out NA values in 'mental_health_tx_hx' and calculate percentages
psych_hosp_hx_by_depression_pct_data <- complete_cases_all |> 
  drop_na(psych_hosp_hx, depression_level_at_year_1) |>
  count(depression_level_at_year_1, psych_hosp_hx) |> 
  group_by(depression_level_at_year_1) |>
  mutate(pct = n / sum(n) * 100)

# Add a new column to determine the vertical position of the text based on 'pct'
psych_hosp_hx_by_depression_pct_data <- psych_hosp_hx_by_depression_pct_data |>
  mutate(text_y_position = if_else(pct <= 5, pct + 1, pct / 2),  # Adjust the position above the bar slightly for <= 5%
         text_vjust = if_else(pct <= 5, -1.0, 0))  # Use different vjust values based on the pct
...
gg.psych_hosp_hx_by_depression_pct <- ggplot(psych_hosp_hx_by_depression_pct_data,
  ...
  scale_fill_manual(values = c("Denied any history of psychiatric hospitalization" = "#CFD8DC", 
                               "Psychiatric hospital admission prior to year preceding index injury only" = "#546E7A",
                               "Psychiatric hospital admission within year preceding index injury" = "#37474F")) +
  geom_text(aes(label = sprintf("%.1f%%", pct), y = text_y_position, vjust = text_vjust),  # Center text in the middle of each bar and format with one decimal place
            position = position_dodge(width = 0.9),
            family = "Proxima Nova",
            fontface = "bold",
            size = 2.75,
...
# Save the plot
ggsave(here(univariate_and_bivariate_plots_dir, "figure_13-2_psych_hosp_hx_by_depression_pct_complete_case_sample.png"), 
       gg.psych_hosp_hx_by_depression_pct, bg = "#FFFFFF", dpi = 300)
```

### Figures 14-1 and 14-2: Counts and Percentages of Problematic Substance Use at Injury by Year 1 Depression Level
...
# Save the plot
ggsave(here(univariate_and_bivariate_plots_dir, "figure_14-1_problematic_substance_use_at_injury_by_depression_final_analytic_sample.png"),
...
# Save the plot
ggsave(here(univariate_and_bivariate_plots_dir, "figure_14-1_problematic_substance_use_at_injury_by_depression_complete_case_sample.png"),
       gg.problematic_substance_use_at_injury_by_depression, bg = "#FFFFFF", dpi = 300)
```
...
# Save the plot
ggsave(here(univariate_and_bivariate_plots_dir, "figure_14-2_problematic_substance_use_at_injury_by_depression_pct_final_analytic_sample.png"), 
...
# Save the plot
ggsave(here(univariate_and_bivariate_plots_dir, "figure_14-2_problematic_substance_use_at_injury_by_depression_pct_complete_case_sample.png"), 
       gg.problematic_substance_use_at_injury_by_depression_pct, bg = "#FFFFFF", dpi = 300)
```

### Figures 15-1 and 15-2: Counts and Percentages of Problematic Substance Use at Year 1 by Year 1 Depression Level
...
# Save the plot
ggsave(here(univariate_and_bivariate_plots_dir, "figure_15-1_problematic_substance_use_at_year_1_by_depression_final_analytic_sample.png"), 
...
# Save the plot
ggsave(here(univariate_and_bivariate_plots_dir, "figure_15-1_problematic_substance_use_at_year_1_by_depression_complete_case_sample.png"), 
       gg.problematic_substance_use_at_year_1_by_depression, bg = "#FFFFFF", dpi = 300)
```
...
# Save the plot
ggsave(here(univariate_and_bivariate_plots_dir, "figure_15-2_problematic_substance_use_at_year_1_by_depression_pct_final_analytic_sample.png"), 
...
# Save the plot
ggsave(here(univariate_and_bivariate_plots_dir, "figure_15-2_problematic_substance_use_at_year_1_by_depression_pct_complete_case_sample.png"), 
       gg.problematic_substance_use_at_year_1_by_depression_pct, bg = "#FFFFFF", dpi = 300)
```

### Figures 16-1 and 16-2: Counts and Percentages of Lifetime Suicide Attempt at Injury and History of Suicide Attempt by Year 1 Depression Level

```{r Plot Figure 16-1 (Final Analytic Sample)}
# Relevel the factor variable
analytic_data_final <- analytic_data_final |>
...
# Save the plot
ggsave(here(univariate_and_bivariate_plots_dir, "figure_16-1_suicide_attempt_hx_lifetime_at_injury_by_depression_final_analytic_sample.png"), 
       gg.suicide_attempt_hx_lifetime_at_injury_by_depression, bg = "#FFFFFF", dpi = 300)
```

```{r Plot Figure 16-1 (Complete-Case Sample)}
# Relevel the factor variable
complete_cases_all <- complete_cases_all |>
  mutate(suicide_attempt_hx_lifetime_at_injury = factor(suicide_attempt_hx_lifetime_at_injury, 
                                                        levels = c("No",
...
# Save the plot
ggsave(here(univariate_and_bivariate_plots_dir, "figure_16-1_suicide_attempt_hx_lifetime_at_injury_by_depression_complete_case_sample.png"), 
       gg.suicide_attempt_hx_lifetime_at_injury_by_depression, bg = "#FFFFFF", dpi = 300)
```

```{r Plot Figure 16-2 (Final Analytic Sample)}
# Relevel the factor variable
analytic_data_final <- analytic_data_final |>
  mutate(suicide_attempt_hx_lifetime_at_injury = factor(suicide_attempt_hx_lifetime_at_injury, 
                                                        levels = c("No",
...
# Save the plot
ggsave(here(univariate_and_bivariate_plots_dir, "figure_16-2_suicide_attempt_hx_lifetime_at_injury_by_depression_pct_final_analytic_sample.png"), 
       gg.suicide_attempt_hx_lifetime_at_injury_by_depression_pct, bg = "#FFFFFF", dpi = 300)
```

```{r Plot Figure 16-2 (Complete-Case Sample)}
# Relevel the factor variable
complete_cases_all <- complete_cases_all |>
  mutate(suicide_attempt_hx_lifetime_at_injury = factor(suicide_attempt_hx_lifetime_at_injury, 
                                                        levels = c("No",
...
# Save the plot
ggsave(here(univariate_and_bivariate_plots_dir, "figure_16-2_suicide_attempt_hx_lifetime_at_injury_by_depression_pct_complete_case_sample.png"), 
       gg.suicide_attempt_hx_lifetime_at_injury_by_depression_pct, bg = "#FFFFFF", dpi = 300)
```

```{r Plot Figure 16-3 (Final Analytic Sample)}
# Relevel the factor variable
analytic_data_final <- analytic_data_final |>
...
# Save the plot
ggsave(here(univariate_and_bivariate_plots_dir, "figure_16-3_suicide_attempt_hx_by_depression_final_analytic_sample.png"),
       gg.suicide_attempt_hx_by_depression, bg = "#FFFFFF", dpi = 300)
```

```{r Plot Figure 16-3 (Complete-Case Sample)}
# Relevel the factor variable
complete_cases_all <- complete_cases_all |>
  mutate(suicide_attempt_hx = factor(suicide_attempt_hx, 
                                     levels = c("Denied any history of suicide attempt",
...
# Save the plot
ggsave(here(univariate_and_bivariate_plots_dir, "figure_16-3_suicide_attempt_hx_by_depression_complete_case_sample.png"),
       gg.suicide_attempt_hx_by_depression, bg = "#FFFFFF", dpi = 300)
```

```{r Plot Figure 16-4 (Final Analytic Sample)}
# Relevel the factor variable
analytic_data_final <- analytic_data_final |>
  mutate(suicide_attempt_hx = factor(suicide_attempt_hx, 
                                     levels = c("Denied any history of suicide attempt",
...
# Save the plot
ggsave(here(univariate_and_bivariate_plots_dir, "figure_16-4_suicide_attempt_hx_by_depression_pct_final_analytic_sample.png"), 
       gg.suicide_attempt_hx_by_depression_pct, bg = "#FFFFFF", dpi = 300)
```

```{r Plot Figure 16-4 (Complete-Case Sample)}
# Relevel the factor variable
complete_cases_all <- complete_cases_all |>
  mutate(suicide_attempt_hx = factor(suicide_attempt_hx, 
                                     levels = c("Denied any history of suicide attempt",
...
# Save the plot
ggsave(here(univariate_and_bivariate_plots_dir, "figure_16-4_suicide_attempt_hx_by_depression_pct_complete_case_sample.png"), 
       gg.suicide_attempt_hx_by_depression_pct, bg = "#FFFFFF", dpi = 300)
```

### Figures 17-1 and 17-2: Counts and Percentages of Past-Year Suicide Attempt at Injury by Year 1 Depression Level
...
# Save the plot
ggsave(here(univariate_and_bivariate_plots_dir, "figure_17-1_suicide_attempt_hx_past_year_at_injury_by_depression_final_analytic_sample.png"), 
...
# Save the plot
ggsave(here(univariate_and_bivariate_plots_dir, "figure_17-1_suicide_attempt_hx_past_year_at_injury_by_depression_complete_case_sample.png"), 
       gg.suicide_attempt_hx_past_year_at_injury_by_depression, bg = "#FFFFFF", dpi = 300)
```
...
# Save the plot
ggsave(here(univariate_and_bivariate_plots_dir, "figure_17-2_suicide_attempt_hx_past_year_at_injury_by_depression_pct_final_analytic_sample.png"), 
...
# Save the plot
ggsave(here(univariate_and_bivariate_plots_dir, "figure_17-2_suicide_attempt_hx_past_year_at_injury_by_depression_pct_complete_case_sample.png"), 
       gg.suicide_attempt_hx_past_year_at_injury_by_depression_pct, bg = "#FFFFFF", dpi = 300)
```

### Figures 18-1 and 18-2: Counts and Percentages of Past-Year Suicide Attempt at Year 1 by Year 1 Depression Level

```{r Plot 18-1 (Final Analytic Sample)}
# Relevel the factor variable
analytic_data_final <- analytic_data_final |>
...
# Save the plot
ggsave(here(univariate_and_bivariate_plots_dir, "figure_18-1_suicide_attempt_hx_past_year_at_year_1_by_depression_final_analytic_sample.png"), 
       gg.suicide_attempt_hx_past_year_at_year_1_by_depression, bg = "#FFFFFF", dpi = 300)
```

```{r Plot 18-1 (Complete-Case Sample)}
# Relevel the factor variable
complete_cases_all <- complete_cases_all |>
  mutate(suicide_attempt_hx_past_year_at_year_1 = factor(suicide_attempt_hx_past_year_at_year_1, 
                                                         levels = c("No",
...
# Save the plot
ggsave(here(univariate_and_bivariate_plots_dir, "figure_18-1_suicide_attempt_hx_past_year_at_year_1_by_depression_complete_case_sample.png"), 
       gg.suicide_attempt_hx_past_year_at_year_1_by_depression, bg = "#FFFFFF", dpi = 300)
```

```{r Plot 18-2 (Final Analytic Sample)}
# Relevel the factor variable
analytic_data_final <- analytic_data_final |>
  mutate(suicide_attempt_hx_past_year_at_year_1 = factor(suicide_attempt_hx_past_year_at_year_1, 
                                                         levels = c("No",
...
# Save the plot
ggsave(here(univariate_and_bivariate_plots_dir, "figure_18-2_suicide_attempt_hx_past_year_at_year_1_by_depression_pct_final_analytic_sample.png"), 
       gg.suicide_attempt_hx_past_year_at_year_1_by_depression_pct, bg = "#FFFFFF", dpi = 300)
```

```{r Plot 18-2 (Complete-Case Sample)}
# Relevel the factor variable
complete_cases_all <- complete_cases_all |>
  mutate(suicide_attempt_hx_past_year_at_year_1 = factor(suicide_attempt_hx_past_year_at_year_1, 
                                                         levels = c("No",
...
# Save the plot
ggsave(here(univariate_and_bivariate_plots_dir, "figure_18-2_suicide_attempt_hx_past_year_at_year_1_by_depression_pct_complete_case_sample.png"), 
       gg.suicide_attempt_hx_past_year_at_year_1_by_depression_pct, bg = "#FFFFFF", dpi = 300)
```