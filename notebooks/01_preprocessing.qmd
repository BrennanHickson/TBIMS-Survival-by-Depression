...
# Convert 'time_to_event', "time_to_censorship", and "time_to_death" from days to years
analytic_data_imputed <- analytic_data_imputed %>%
  ...
  select(
    ...
    date_of_injury, sex, age,
    age_at_censorship, age_at_expiration,
    cause_of_injury,
    marital_status_at_injury,
    education_level_at_injury,
    employment_at_injury,
...
```{r Select and Arrange the Columns in the Imputed Analytic Sample Data Frame}
# # Select and reorder data columns
# analytic_data_imputed <- analytic_data_imputed |>
#   select(
#     id, data_collection_period,
#     status_at_followup, event_status, 
#     time_to_event_years, time_to_censorship_years,
#     time_to_expiration_years, date_of_followup,
#     date_of_death, date_of_birth,
...
analytic_data_final <- analytic_data_imputed |>
  arrange(id, time_to_event_in_years) |>
  group_by(id) |>
  slice(n()) |>
  ungroup()
