...
#' which is defined as the period starting from a globally defined `observation_period_start_date`
...
#' 
#' @examples
#' # Assume observation_period_start_date is defined globally as '2000-01-01'
...
apply_criterion_1 <- function(data, observation_period_start_date, observation_period_end_date) {
  ...
  data <- data |>
    filter(date_of_year_1_followup >= observation_period_start_date & date_of_year_1_followup <= observation_period_end_date) |>
    arrange(id, date_of_followup, date_of_death) |>
    group_by(id) |>
    mutate(
      study_end_date = date_of_year_1_followup + years(5), # 2017 vs. 2022
      valid_followup = is_within_study_period(date_of_year_1_followup, date_of_followup) | is_within_study_period(date_of_year_1_followup, date_of_death),
...
analytic_data_final_long <- merged_data |>
