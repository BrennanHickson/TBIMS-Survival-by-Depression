...
is_within_study_period <- function(date_of_injury, date_of_followup) {
  participant_end_date <- date_of_injury + years(10)
  !is.na(date_of_followup) & date_of_followup >= observation_period_start_date & date_of_followup <= participant_end_date
}
```
...
apply_criterion_1 <- function(data, observation_period_start_date, observation_period_end_date) {
  ...
  data <- data |>
    ...
    select(id, data_collection_period, status_at_followup, event_status,
           ...
           calendar_year_of_injury, calendar_year_of_event,
           date_of_followup, date_of_death, study_end_date, everything()) |>
