...
# Load the .rds files
analytic_data_final <- readRDS(file.path(data_processed_dir, "/5_year_followup/analytic_data_final.rds"))
na_counts_for_all_proposed_covariates <- readRDS(file.path(data_processed_dir, "/5_year_followup/na_counts_for_all_proposed_covariates.rds"))
na_counts_for_select_covariates <- readRDS(file.path(data_processed_dir, "/5_year_followup/na_counts_for_select_covariates.rds"))

# analytic_data_final <- readRDS(file.path(data_processed_dir, "/10_year_followup/analytic_data_final.rds"))
# na_counts_for_all_proposed_covariates <- readRDS(file.path(data_processed_dir, "/10_year_followup/na_counts_for_all_proposed_covariates.rds"))
# na_counts_for_select_covariates <- readRDS(file.path(data_processed_dir, "/10_year_followup/na_counts_for_select_covariates.rds"))
...
saveRDS(complete_cases_all, here(data_processed_dir, "/5_year_followup/complete_cases_all.rds"))
write.csv(complete_cases_all, file.path(data_processed_dir, "/5_year_followup/complete_cases_all.csv"), row.names = FALSE)
saveRDS(complete_cases_select, here(data_processed_dir, "/5_year_followup/complete_cases_select.rds"))
write.csv(complete_cases_select, here(data_processed_dir, "/5_year_followup/complete_cases_select.csv"), row.names = FALSE)

# saveRDS(complete_cases_all, here(data_processed_dir, "/10_year_followup/complete_cases_all.rds"))
# write.csv(complete_cases_all, file.path(data_processed_dir, "/10_year_followup/complete_cases_all.csv"), row.names = FALSE)
# saveRDS(complete_cases_select, here(data_processed_dir, "/10_year_followup/complete_cases_select.rds"))
# write.csv(complete_cases_select, here(data_processed_dir, "/10_year_followup/complete_cases_select.csv"), row.names = FALSE)
```
...
incomplete_cases_select <- analytic_data_for_cc_select[!complete.cases(analytic_data_for_cc_select), ]
```
...
table_1_1 <- analytic_data_for_tables_all |>
  ...
  gtsave(
    filename = here(output_tables_dir, "/5_year_followup/table_1-1_full_analytic_sample_with_all_proposed_covariates.png")
    # filename = here(output_tables_dir, "/10_year_followup/table_1-1_full_analytic_sample_with_all_proposed_covariates.png")
  )
```
...
table_1_2 <- complete_cases_for_tables_all |>
  ...
  gtsave(
    filename = here(output_tables_dir, "/5_year_followup/table_1-2_complete_case_sample_with_all_proposed_covariates.png")
    # filename = here(output_tables_dir, "/10_year_followup/table_1-2_complete_case_sample_with_all_proposed_covariates.png")
  )
```
