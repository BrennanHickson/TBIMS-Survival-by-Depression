...
saveRDS(na_counts_for_all_proposed_covariates, here(data_processed_dir, "na_counts_for_all_proposed_covariates_5_year_followup.rds"))
saveRDS(na_counts_for_select_covariates_1, here(data_processed_dir, "na_counts_for_select_covariates_1_5_year_followup.rds"))
```
...
![](images/figure_17-2_select_covariates_1_missing_value_counts.png)
...
![](images/figure_18-2_select_covariates_1_missing_patterns_plot.png){fig-align="center"}
