...
# Define select covariates of interest (remove individual function scores, past-year suicide attempt at injury, and problematic substance use at injury)
select_covariates_3 <- c("id", "age", "sex", "education_level_at_injury",
                         "employment_at_injury", "marital_status_at_injury",
                         "rehab_payor_primary", "rehab_payor_primary_type",
                         "cause_of_injury", "func_score_at_year_1",
                         "problematic_substance_use_at_year_1", 
...
analytic_select_covariates_3 <- analytic_data_final |>
  select(all_of(select_covariates_3))
...
select_covariates_3_for_plots <- select(analytic_select_covariates_3, -id)
```
...
na_counts_for_select_covariates_3 <- prepare_na_counts_df(select_covariates_3_for_plots)
```
...
figure_17_3 <- gg_miss_var(select_covariates_2_for_plots) +
  labs(x = "Covariates",
       y = "Number of Missing Values"
  ) +
  scale_x_discrete(
...
### Figure 17-4 Count of Missing Values Across All Proposed Covariates Excluding Functional Variables, Past-Year History of Suicide Attempt at Injury, and Problematic Substance Use at Injury

```{r Plot Figure 17-4}
# Plot the number of missing values across all covariates excluding functional status scores and past-year history of suicide attempt at injury
figure_17_4 <- gg_miss_var(select_covariates_3_for_plots) +
  labs(x = "Covariates",
       y = "Number of Missing Values"
  ) +
  scale_x_discrete(
...
ggsave(here(missingness_plots_dir, "figure_17-4_select_covariates_3_missing_value_counts.png"),
       figure_17_4, dpi = 300)
```
...
# figure_18_1 <- gg_miss_upset_custom(all_proposed_covariates_for_plots, 
#                                     all_proposed_covariates_labels)
# 
# # Convert the plot to a ggplot object
# figure_18_1_ggplot <- as.ggplot(figure_18_1)
# 
# ggsave(here(missingness_plots_dir, "figure_18-1_all_proposed_covariates_missing_patterns_plot.png"),
#        ggplotify::as.ggplot(figure_18_1_ggplot), dpi = 300)
...
# pdf(file_path, width = 16, height = 12)
...
```{r Plot Figure 18-2}
# Generate an upset plot of missing values across all proposed covariates excluding functional variables
# figure_18_2 <- gg_miss_upset_custom(select_covariates_1_for_plots, 
#                                     all_proposed_covariates_labels)
# 
# # Convert the plot to a ggplot object
# figure_18_2_ggplot <- as.ggplot(figure_18_2)
# 
# ggsave(here(missingness_plots_dir, "figure_18-2_select_covariates_1_missing_patterns_plot.png"),
#        ggplotify::as.ggplot(figure_18_2_ggplot), dpi = 300)
...
### Figure 18-3: Patterns of Missingness Across All Proposed Covariates Excluding Functional Variables and Past-Year History of Suicide Attempt at Injury

```{r Plot Figure 18-3}
# Generate an upset plot of missing values across all proposed covariates excluding functional variables and past-year history of suicide attempt at injury
# figure_18_3 <- gg_miss_upset_custom(select_covariates_2_for_plots, 
#                                     all_proposed_covariates_labels)
# 
# # Convert the plot to a ggplot object
# figure_18_3_ggplot <- as.ggplot(figure_18_3)
# 
# ggsave(here(missingness_plots_dir, "figure_18-3_select_covariates_2_missing_patterns_plot.png"),
#        ggplotify::as.ggplot(figure_18_3_ggplot), dpi = 300)

# Define file path
file_path <- here(missingness_plots_dir, "figure_18-3_select_covariates_2_missing_patterns_plot.png")
...
# Generate the plot
gg_miss_upset_custom(select_covariates_2_for_plots, 
                     all_proposed_covariates_labels)
...
### Figure 18-4: Patterns of Missingness Across All Proposed Covariates Excluding Functional Variables, Past-Year History of Suicide Attempt at Injury, and Problematic Substance Use at Injury

```{r Plot Figure 18-4}
# Generate an upset plot of missing values across all proposed covariates excluding functional variables, past-year history of suicide attempt at injury, and problematic substance use at Year 1
# figure_18_4 <- gg_miss_upset_custom(select_covariates_3_for_plots, 
#                                     all_proposed_covariates_labels,
#                                     set_size.show = TRUE)
# 
# # # Convert the plot to a ggplot object
# figure_18_4_ggplot <- as.ggplot(figure_18_4)
# 
# ggsave(here(missingness_plots_dir, "figure_18-4_select_covariates_3_missing_patterns_plot.pdf"),
#        ggplotify::as.ggplot(figure_18_4), dpi = 300)

# Define file path
file_path <- here(missingness_plots_dir, "figure_18-4_select_covariates_3_missing_patterns_plot.png")
...
# Generate the plot
gg_miss_upset_custom(select_covariates_3_for_plots, 
                     all_proposed_covariates_labels)
