...
# saveRDS(na_counts_for_all_proposed_covariates, here(data_processed_dir, "/5_year_followup/na_counts_for_all_proposed_covariates.rds"))
# saveRDS(na_counts_for_select_covariates, here(data_processed_dir, "/5_year_followup/na_counts_for_select_covariates.rds"))
saveRDS(na_counts_for_all_proposed_covariates, here(data_processed_dir, "/10_year_followup/na_counts_for_all_proposed_covariates.rds"))
saveRDS(na_counts_for_select_covariates, here(data_processed_dir, "/10_year_followup/na_counts_for_select_covariates.rds"))
```
...
# ggsave(here(missingness_plots_dir, "/5_year_followup/figure_17-1_all_proposed_covariates_missing_value_counts.png"),
#        figure_17_1, dpi = 300)

ggsave(here(missingness_plots_dir, "/10_year_followup/figure_17-1_all_proposed_covariates_missing_value_counts.png"),
       figure_17_1, dpi = 300)
```
...
figure_17_2 <- gg_miss_var(select_covariates_for_plots) +
  labs(x = "Covariates",
       y = "Number of Missing Values"
  ) +
  scale_x_discrete(labels = var_name_mapping) +
...
# ggsave(here(missingness_plots_dir, "/5_year_followup/figure_17-2_select_covariates_missing_value_counts.png"),
#        figure_17_2, dpi = 300)

ggsave(here(missingness_plots_dir, "/10_year_followup/figure_17-2_select_covariates_missing_value_counts.png"),
       figure_17_2, dpi = 300)
```
...
# Define file path
# file_path <- here(missingness_plots_dir, "/5_year_followup/figure_18-1_all_proposed_covariates_missing_patterns_plot.png")
file_path <- here(missingness_plots_dir, "/10_year_followup/figure_18-1_all_proposed_covariates_missing_patterns_plot.png")
...
# Define file path
# file_path <- here(missingness_plots_dir, "/5_year_followup/figure_18-2_select_covariates_missing_patterns_plot.png")
file_path <- here(missingness_plots_dir, "/10_year_followup/figure_18-2_select_covariates_missing_patterns_plot.png")
