...
#'
#' @export
log_sample_size <- function(data, criterion_number, original_data = NULL) {
...
#'
#' @export
log_removed_ids <- function(original_data, filtered_data, criterion_number) {
  # Use the global log directory
...
```{r Define a Function to Apply Study Eligibility Criterion 1 (Inclusion): Injured between October 1, 2006 and October 1, 2012 with Follow-Up for Up to 5 Years Post-Injury}
...
apply_criterion_1 <- function(data, study_entry_period_start_date, study_entry_period_end_date) {
  ...
  log_sample_size(data, 1, original_data)
