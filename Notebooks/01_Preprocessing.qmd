...
```{r Define Data Cleaning Functions}
# Function to replace study-specific missing values
...
# Function to calculate each participant's end date and check if follow-up date is within the study period
