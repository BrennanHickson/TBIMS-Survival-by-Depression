...
# Create the 'Output/Tables' subdirectory if not already accessible
...
saveRDS(complete_cases_select, here(data_processed_dir, "complete_cases_select.rds"))
write.csv(complete_cases_select, here(data_processed_dir, "complete_cases_select.csv"), row.names = FALSE)
```
