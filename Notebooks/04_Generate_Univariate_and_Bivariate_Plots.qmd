...
# Create the age distribution by depression plot
figure_2_4 <- ggplot(analytic_data_final,
                                            aes(
                                              x = age_at_expiration, 
                                              y = depression_level_at_year_1,
                                              fill = depression_level_at_year_1,
...
ggsave(here(univariate_and_bivariate_plots_dir, "figure_2-4_age_at_expiration_distribution_by_depression_final_analytic_sample.png"),
       figure_2_4, dpi = 300, bg = "white")
```
